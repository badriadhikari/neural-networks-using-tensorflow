...
* Notebooks: [Numpy](./notebooks/numpy.ipynb), [Matplotlib & Plotly](./notebooks/matplotlib_plotly.ipynb), [Pandas](./notebooks/pandas.ipynb), and [Normalization techniques](./notebooks/normalization_techniques.ipynb)
...
* Notebook: [Univariate Linear Regression](./notebooks/Univariate_linear_regression.ipynb)
...
* Notebook: [Logistic regression](Logistic_regression.ipynb)
...
* Notebook: [Binary classification](./notebooks/Binary_classification.ipynb)
